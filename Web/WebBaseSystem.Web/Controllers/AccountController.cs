namespace WebBaseSystem.Web.Controllers
{
    ...
    using WebBaseSystem.Web.Models;
    using WebBaseSystem.Web.Providers;
    using WebBaseSystem.Web.Results;
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> GetExternalLogin(string provider, string error = null)
        {
            ...
            User user = await this.UserManager.FindAsync(new UserLoginInfo(externalLogin.LoginProvider, externalLogin.ProviderKey));
